...
const COMMIT_HASH = '88570208bdd3dc88ab2e13bbf7de370b3b8dba38'
...
export function renderHTML(body, pLink, pIdx) {
  ...
  <html lang="en">
    <head>
      ...
      <title>deltaonealpha's storage server</title>
    ...
    <body>
      <nav id="navbar" data-turbolinks-permanent><div class="brand">📁 deltaonealpha's storage server</div></nav>
      ${body}
      <div class="paginate-container">${pagination(pIdx)}</div>
      <div id="flex-container" data-turbolinks-permanent style="flex-grow: 1;"></div>
      <footer id="footer" data-turbolinks-permanent><p>Powered by <a href="https://github.com/spencerwooo/onedrive-cf-index">onedrive-cf-index</a>, hosted on <a href="https://www.cloudflare.com/products/cloudflare-workers/">Cloudflare Workers</a><br>deltasoftware.</p></footer>
      <script>
